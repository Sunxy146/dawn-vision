...
<p align="center">
  <img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/banner.png" alt="DawnVision — One line of text. One finished short drama." width="100%" />
</p>

<h1 align="center">🌬️ DawnVision <sub><sup>v12.264</sup></sub></h1>
...
<p align="center">
  <a href="https://github.com/Sunxy146/dawn-vision/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg" alt="MIT License" /></a>
  <a href="https://github.com/Sunxy146/dawn-vision/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/Sunxy146/dawn-vision/ci.yml?branch=main&label=CI&logo=github" alt="CI" /></a>
  <a href="https://github.com/Sunxy146/dawn-vision/stargazers"><img src="https://img.shields.io/github/stars/Sunxy146/dawn-vision?style=social" alt="GitHub stars" /></a>
...
<p align="center">
  <b>English</b> · <a href="https://github.com/Sunxy146/dawn-vision/blob/main/README.zh-CN.md">简体中文</a> · <a href="https://github.com/Sunxy146/dawn-vision/blob/main/docs/MARKETING-en.md">🔥 Pitch</a> · <a href="https://github.com/Sunxy146/dawn-vision/blob/main/docs/llm-providers.md">🔌 BYO LLM</a>
</p>

<p align="center">
  <a href="https://github.com/Sunxy146/dawn-vision/raw/main/assets/promo/dawn-vision-promo-en.mp4">
    <img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/promo/dawn-vision-promo.gif" alt="DawnVision — 39-second promo (click to watch with voiceover &amp; sound)" width="100%" />
  </a>
</p>
<p align="center">
  ▶ <a href="https://github.com/Sunxy146/dawn-vision/raw/main/assets/promo/dawn-vision-promo-en.mp4"><b>Watch the full 39-second promo — with voiceover &amp; sound</b></a><br/>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/diagrams/architecture.png" alt="DawnVision system architecture — Next.js client · orchestration · 8-agent pipeline · LLM gateway · 12+ media engines · quality / data / realtime platform" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/diagrams/sequence.png" alt="Sequence diagram — one idea to one finished film, with the Vision-Audit retry loop and multi-engine race" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/diagrams/dataflow.png" alt="Data-flow diagram — the artifact refinery from text to final.mp4, persisted to DbDriver and the asset store" width="100%" /></p>
...
> 🎞️ Diagrams are **animated SVG, authored as code** in [`assets/diagrams/`](https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/diagrams/) — crisp at any zoom, versioned with the source. *(Animation renders on GitHub; the ModelScope mirror shows static PNG.)*
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/landing.png" alt="DawnVision landing — 晓阳叙影 AI Animation Agent Studio, 8 agents · 7 engines · 3 consistency guards, looping cinematic hero" width="100%" />
...
<table>
<tr>
<td width="50%"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/create.png" /><br/><sub><b>创作工坊</b> — one line → film: style presets · multi-ref element shelf · character lock · live preview · gold-neon genre gallery</sub></td>
<td width="50%"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/templates.png" /><br/><sub><b>模板市场</b> — preview clips · ★ ratings / ♥ favorites · quality score · one-click remix (carries voices)</sub></td>
</tr>
<tr>
<td width="50%"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/qc.png" /><br/><sub><b>成片质检 + 配音口型</b> — four-dimension publish gate · consistency trend · viseme track (animated mouth + measured alignment) · per-shot Vision scores</sub></td>
<td width="50%"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/cost.png" /><br/><sub><b>技术监看 · 成本归因</b> — per-stage cost share (video / image / LLM / TTS / lip-sync) + saving hints</sub></td>
</tr>
</table>
...
> Notes are consolidated **per major version** — the full minor-by-minor changelog lives in [`VERSIONS.md`](https://github.com/Sunxy146/dawn-vision/blob/main/VERSIONS.md) / [`ROADMAP.md`](https://github.com/Sunxy146/dawn-vision/blob/main/ROADMAP.md).
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/director-console.png" width="100%" /></p>

### 📖 Novel → season, with real voiceover *(v6.2)*
Paste a full novel; DawnVision splits it into episodes by chapter markers (or by target length), picks a narration mode, and can render a real narration track + burnable subtitles for the whole season in parallel.
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/story-intake.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v6/styles.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v6/health.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v8/polish-pro-audit.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v8/character-studio.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/final-film.png" width="100%" /></p>

### 👥 Team Workspace *(v6.5)*  ·  🎞️ Cinema Timeline + narration track *(v6.2.4)*
<table>
<tr>
<td width="50%"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/team.png" /><br/><sub>Credit pool + per-member allocations, RBAC, real invite links.</sub></td>
<td width="50%"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v10/cinema-timeline.png" /><br/><sub>Multi-track timeline; narration audio + subtitles burned in.</sub></td>
</tr>
</table>
...
| You are... | What DawnVision gives you |
|---|---|
...
Every text-LLM call (Director / Writer / Vision / Audit) goes through one OpenAI-compatible `chat/completions` endpoint. Want to swap to DeepSeek-r1 / GPT-4o / Claude (via OpenRouter) / Qwen-Max / local Ollama? **Edit 3 lines in `.env`. Zero code change.** See [`docs/llm-providers.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/llm-providers.md) for the full matrix.
...
> 结论不变:**生成层已是红海(竞品在出片/多镜/音频都第一梯队),DawnVision 护城河收窄到「制作/平台层」**——节奏审计、智能剪辑、字幕烧入、协作、自托管、开源、BYO。

| Capability | Veo 3.1 | Kling 3.0 | Seedance 2.0 | Runway Gen-4.5 | Gemini Omni Flash | HappyHorse-1.1 | **DawnVision** |
|---|---|---|---|---|---|---|---|
...
|---|---|
| ![我的项目](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/01-my-projects-manage.png) | ![拉片](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/04-pull-sheet-replicate.png) |

| 素材库 · 资产管理 | API 健康 · 模型雷达 |
|---|---|
| ![素材库](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/02-my-assets-manage.png) | ![模型雷达](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/03-api-health-model-radar.png) |

| 钩子审计三指标 | 一句指令调剪辑风格(v12.0.4) |
|---|---|
| ![钩子审计](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/05-pacing-hook-audit.png) | ![剪辑风格](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/06-edit-style-instruction.png) |

| 片段预览音频:三态徽章 + 带声试听(v12.1.2) | |
|---|---|
| ![片段音频预览](https://github.com/Sunxy146/dawn-vision/blob/main/docs/screenshots/v12/07-clip-audio-preview.png) | 左:带配音(TTS 叠层)+ 带声试听开关 · 右:片段无独立音轨(成片含配乐+配音) |

完整逐版本核心迭代见 [`VERSIONS.md`](https://github.com/Sunxy146/dawn-vision/blob/main/VERSIONS.md);阶段计划见 `docs/stage18`–`docs/stage20`。
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-dashboard-v3.1.3.png" width="100%" /></p>

### Asset library
Cross-project reusable: 角色 / 场景 / 视频 / 音乐 / 字幕 / 模板 — 1467 assets in this demo project.
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-assets-v3.1.3.png" width="100%" /></p>

### Project library
Every short film with auto-generated cinematic covers + status badges + quality donut.
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-projects-v3.1.3.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v8/creation-canvas.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/v8/script-shotlist.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-cinema-timeline-v3.1.3.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-pacing-v3.1.3.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-comments-v3.1.3.png" width="100%" /></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/Sunxy146/dawn-vision/main/assets/screenshot-workshop-v3.1.3.png" width="100%" /></p>
...
- **Swap anything** in `.env.local` (`OPENAI_*` / `OPENAI_CREATIVE_*` / `VEO_*` / `IMAGE_MODEL` / `VE_TTS_MODEL` / `MINIMAX_*`) — zero code change. See [`docs/llm-providers.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/llm-providers.md).
...
```bash
# 1. clone + install
git clone https://github.com/Sunxy146/dawn-vision.git
cd dawn-vision
npm install
...
See [`CONTRIBUTING.md`](https://github.com/Sunxy146/dawn-vision/blob/main/CONTRIBUTING.md) for the repo's contribution guide.

---

## 📚 Docs

- [`docs/llm-providers.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/llm-providers.md) — Swap LLM provider in 3 env vars
- [`docs/SCREENSHOTS.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/SCREENSHOTS.md) — Module-by-module screenshot manifest
- [`docs/MARKETING-en.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/MARKETING-en.md) · [`docs/MARKETING-zh.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/MARKETING-zh.md) — Pitch deck copy
- [`ROADMAP.md`](https://github.com/Sunxy146/dawn-vision/blob/main/ROADMAP.md) — Full sprint-by-sprint changelog (v2.10 → v9.2.0) · [`VERSIONS.md`](https://github.com/Sunxy146/dawn-vision/blob/main/VERSIONS.md) — version history table
- [`docs/COMPETITIVE-GAP-2026-05.md`](https://github.com/Sunxy146/dawn-vision/blob/main/docs/COMPETITIVE-GAP-2026-05.md) — Honest analysis vs Sora/Kling/Vidu/Higgsfield
...
- **[@flobo3](https://github.com/flobo3)** — [#11](https://github.com/Sunxy146/dawn-vision/issues/11): proposed **GPT Image** (`gpt-image-1`) and **Nano Banana** (Gemini Image) as first-class image providers, including the endpoints, the env-var naming, the "reuse the already-configured `OPENAI_API_KEY` to lower the barrier" idea, and the observation that Nano Banana's native i2i fits the existing character-consistency contract. Shipped in v12.247–v12.247 essentially as designed.
- **[@MikhailNikolaev44](https://github.com/MikhailNikolaev44)** — [#2](https://github.com/Sunxy146/dawn-vision/issues/2): reported that selected characters were being ignored on shot regeneration, which uncovered **three** separate bugs in the reference-image path (v12.132–v12.134), plus the script-language selector request.
- **[@JSap0914](https://github.com/JSap0914)** — [#1](https://github.com/Sunxy146/dawn-vision/pull/1): fixed broken README links.
...
If DawnVision saved you time, a star helps other creators find it.

[![Star History Chart](https://api.star-history.com/svg?repos=Sunxy146/dawn-vision&type=Date)](https://star-history.com/#Sunxy146/dawn-vision&Date)

---

<p align="center">
  Built with ❤️ by people who believe AI-generated drama should feel like a show, not a tech demo.<br/>
  <a href="https://github.com/Sunxy146/dawn-vision/stargazers">⭐ Star us</a> if DawnVision saved you a week.
</p>
