...
> DawnVision — 开源多 Agent AI 流水线, 比 Sora 多 6 个 agent, 比 Kling 多一个时间线编辑器, 比 Higgsfield 开源.

---

## 🔥 微博 / 小红书 短文案 (140 字)

> 🌬️ **DawnVision** 来了 — 一句话进, 整片短剧出.
> ✅ 多 Agent 不是黑盒大模型
> ✅ 锁脸三件套 + Vision 审计
...
> ⭐ 开源 MIT, GitHub: Sunxy146/dawn-vision
...
最近开源了 [DawnVision](https://github.com/Sunxy146/dawn-vision), 一条诚实的多 Agent AI 流水线, 不是"超大模型把全干了". 8 个 agent 各司其职:
...
为什么这套思路赢: 你单走任何一家 (Sora / Kling / Vidu / Runway) 都会卡在"6 镜画风不一致 / 角色变脸 / 中文字幕变鬼画符 / 没节奏感". DawnVision 给每一个问题都加了一层"显式契约":
...
3507 个单测全过 / TypeScript 严格模式 / MIT 开源.
...
# DawnVision: 我开源了一个"一句话出整片短剧"的 AI 流水线 — 比 Sora 多 6 个 agent
...
- (Sora 2 已停服:App 2026-04-26 / API 2026-09-24,移出对比;HappyHorse-1.0 阿里 4 月匿名登顶后退居前列.)**结论不变:生成层是红海,DawnVision 护城河在「制作/平台层」—— 节奏审计、智能剪辑、字幕烧入、协作、自托管、开源、BYO 当下最强引擎.**
- 共同缺口 (= DawnVision 的护城河): 真·中文字幕烧入 · 竖屏短剧套路 · 自托管 · 自带 LLM · 开源 · 实时协作 · 节奏审计 · 智能剪辑.

我想要的: **开源 + 多 Agent 协同 + 中文优先 + 自带 LLM + 实时多人协作**. 都没有. 自己造一个.

8 个月, v2.0 → v12.263, 3507 个单测, MIT 开源. 这就是 **DawnVision**.
...
> 别再用 Sora 拍 5 秒了. 我用开源工具一句话出 30 秒短剧, 还能多人协作改片. GitHub 搜 dawn-vision.

> 漫剧创作者必看: 锁脸 + 中文字幕 + BGM + 实时协作 + 接你自己的 LLM. 全是开源的. 链接 GitHub: Sunxy146/dawn-vision.

> 你 AI 短剧的中文字幕是不是全是鬼画符? 试试 dawn-vision, ffmpeg + PingFang 真烧字幕, 终结鬼画符.

---

## 🔥 Twitter / 即刻 短贴

> 🌬️ DawnVision v12.263 来了
>
> · 一句 idea → 整部短剧
> · 8 agent 流水线
...
> DawnVision — One sentence in, a finished short drama out.
...
> Show HN: DawnVision – open-source multi-agent pipeline turns 1 sentence into a finished short drama
>
> github.com/Sunxy146/dawn-vision
...
> [Open Source] DawnVision - 8-agent pipeline that turns one sentence into a finished short drama with character consistency, locked visual style, real CJK subtitles, and a multiplayer timeline. MIT licensed, BYO LLM (12+ providers, 3 env vars).

---

## 🔥 GitHub 简介 (about)

> One sentence → finished short drama. Multi-agent AI pipeline · cinematic storyboards · real-time collab timeline · BYO LLM · open source · 3507 tests passing.
