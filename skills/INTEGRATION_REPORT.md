...
已成功将从 Vidu 平台提取的 Skills 集成到 `dawn-vision` 项目中。
...
```
D:/developProject/dawn-vision/skills/
├── README.md                              # Skills 总览
├── base/                                  # 基础能力
...
```bash
cd D:/developProject/dawn-vision/skills
cat README.md
```
...
- **Skills 目录**: `D:/developProject/dawn-vision/skills/`
- **实现文件**: `D:/developProject/dawn-vision/skills/skills-implementation.ts`
- **使用示例**: `D:/developProject/dawn-vision/skills/examples/skill-usage-examples.md`
