...
const STEPS = [
  {
    ...
    body: 'DawnVision 🌬️ — 多 Agent AI 漫剧流水线',
  ...
  },
  {
    ...
    sectionMatch: (s) => s.title === '中文版' && s.body.some((l) => l.includes('DawnVision 🌬️')),
  ...
  },
  {
    ...
    sectionMatch: (s) => /DawnVision v3\.1\.3 \. English card/.test(s.title) || s.title === 'DawnVision v3.1.3 · English card',
  ...
  {
    title: '步骤 7/8 · 仓库链接',
    body: 'https://github.com/Sunxy146/dawn-vision',
