                  ...
                  <div className="absolute bottom-3 right-3 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        router.push(`/dashboard/create?resume=${encodeURIComponent(p.id)}`);
                      }}
                      className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#E8C547]/90 hover:bg-[#E8C547] text-black text-[10px] font-semibold shadow-lg shadow-black/30 backdrop-blur-sm"
                      title="打开创作工坊对话与工作流画布"
                    >
                    ...
                    {p.scriptData?.shots?.length > 0 ? (
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-white/90 hover:bg-white text-black text-[10px] font-semibold shadow-lg shadow-black/30 backdrop-blur-sm"
