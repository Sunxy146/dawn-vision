            ...
            <div className="flex gap-2 flex-wrap">
              {character.imageUrls.map((url, i) => (
                <ZoomableImage
                  ...
                  src={url}
                  alt={character.name}
                  title={`${character.name} · 参考图 ${i + 1}`}
                  className="w-20 h-20 rounded-xl border border-[var(--border)] overflow-hidden cursor-zoom-in"
