...
const zhCN: Translations = {
  ...
  cases: {
    title: '案例库',
    titlePublic: '案例精选',
    subtitle: '来自晓阳叙影合作伙伴与创作者',
    subtitleReuse: '来自晓阳叙影合作伙伴与创作者 · 点击一键复用创意',
    copyPrompt: '复制提示词',
    copied: '已复制',
    usePrompt: '用这个创作',
  },
  ...
  pricing: {
    ...
    titleLead: '选择适合你的',
    titleHighlight: '创作套餐',
    subtitle: '从免费体验到企业私有化部署，晓阳叙影为每位创作者提供最合适的 AI 漫剧制作方案',
    custom: '定制',
    ...
    faqTitle: '常见问题',
    faq: [
      { q: '免费版有哪些限制？', a: '免费版每月可创建 3 个项目，角色库最多存储 5 个角色，视频导出分辨率为 720p，并包含晓阳叙影水印。适合个人体验使用。' },
      { q: '升级后能立即使用新功能吗？', a: '是的，付款成功后系统将立即激活对应套餐的权益，无需等待审核。' },
      { q: '专业版的商业授权包含哪些范围？', a: '专业版商业授权允许将使用晓阳叙影生成的内容用于商业目的，包括广告、品牌宣传、影视发行等，但不包含源模型的二次训练权利。' },
  ...
  help: {
    ...
    faqs: [
      ...
      { q: '生成的作品可以商用吗？', a: '生成素材的版权归属各底层生成引擎(Kling / MiniMax 等),是否可商用取决于各引擎的服务条款,请自行核对。晓阳叙影仅提供多智能体编排与后期编辑工具,不对生成素材的商用权利作担保。' },
...
const en: Translations = {
  ...
  cases: {
    ...
    subtitle: 'From DawnVision partners and creators',
    subtitleReuse: 'From DawnVision partners and creators · click to reuse the idea',
  ...
  home: {
    ...
    casesSubtitle: 'From DawnVision partners and creators.',
    casesTryNow: 'Try Now',
  ...
  pricing: {
    ...
    subtitle: 'From free trials to enterprise self-hosting, DawnVision offers every creator the right AI comic-production plan.',
    custom: 'Custom',
    ...
    faqTitle: 'FAQ',
    faq: [
      { q: 'What are the limits of the Free plan?', a: 'The Free plan allows 3 projects per month, up to 5 characters in the library, 720p video export, and includes a DawnVision watermark. Best for individual trials.' },
      ...
      { q: 'Can I use generated content commercially?', a: "Copyright of generated assets belongs to the underlying engines (Kling, MiniMax, etc.). Whether you may use them commercially depends on each engine's terms of service — please verify them yourself. DawnVision only provides multi-agent orchestration and post-production tooling; it does not grant or guarantee commercial rights over generated content." },
...
const ko: Translations = {
  ...
  "cases": {
    "title": "쇼케이스",
    "titlePublic": "추천 케이스",
    "subtitle": "DawnVision 파트너 및 크리에이터의 작품",
    "subtitleReuse": "DawnVision 파트너 및 크리에이터 · 클릭하여 아이디어 재사용",
    "copyPrompt": "프롬프트 복사",
    "copied": "복사됨",
    "usePrompt": "이걸로 만들기"
  },
  "home": {
    ...
    "casesTitle": "추천 케이스",
    "casesSubtitle": "DawnVision 파트너 및 크리에이터의 작품",
    "casesTryNow": "지금 체험",
  ...
  "pricing": {
    ...
    "subtitle": "무료 체험부터 기업 자체 호스팅까지, DawnVision이 모든 크리에이터에게 최적의 AI 만화 제작 플랜을 제공합니다",
    "custom": "맞춤형",
    ...
    "faq": [{
        ...
        "a": "무료 플랜은 월 3개 프로젝트, 캐릭터 라이브러리 최대 5개, 720p 비디오 내보내기, DawnVision 워터마크가 포함됩니다. 개인 체험에 적합합니다."
      }, {
        "q": "업그레이드 후 바로 새 기능을 사용할 수 있나요?",
        "a": "네. 결제가 완료되면 해당 플랜 혜택이 즉시 활성화됩니다 — 검토 대기 없습니다."
      }, {
        "q": "Pro 상업용 라이선스는 어디까지 적용되나요?",
        "a": "Pro 상업용 라이선스를 통해 DawnVision으로 생성한 콘텐츠를 광고, 브랜딩, 영상 배급 등 상업 목적으로 사용할 수 있습니다. 단, 소스 모델 재훈련 권리는 포함되지 않습니다."
      }, {
  ...
  "help": {
    ...
    "faqs": [{
        ...
        "a": "생성된 자산의 저작권은 각 기반 엔진(Kling / MiniMax 등)에 귀속됩니다. 상업적 사용 가능 여부는 각 엔진의 이용약관에 따르므로 반드시 직접 확인하세요. DawnVision은 멀티 에이전트 편집·후처리 도구만 제공하며 생성물의 상업적 권리를 보장하지 않습니다."
      }, {
        "q": "작품을 어떻게 내보내나요?",
...
const ru: Translations = {
  ...
  "cases": {
    ...
    "subtitle": "От партнёров и авторов DawnVision",
    "subtitleReuse": "От партнёров и авторов DawnVision · нажмите, чтобы использовать идею",
  ...
  "home": {
    ...
    "casesSubtitle": "От партнёров и авторов DawnVision.",
  ...
  "pricing": {
    ...
    "subtitle": "От бесплатного доступа до корпоративного self-hosting — DawnVision предлагает каждому автору оптимальный план.",
    ...
    "faq": [{
        ...
        "a": "Бесплатный план позволяет 3 проекта в месяц, до 5 персонажей в библиотеке, экспорт видео в 720p и включает водяной знак DawnVision. Подходит для личного ознакомления."
      }, {
        ...
        "a": "Авторские права на сгенерированные материалы принадлежат базовым движкам (Kling, MiniMax и др.). Возможность коммерческого использования зависит от условий каждого движка — проверяйте их самостоятельно. DawnVision предоставляет только инструменты оркестрации и постобработки и не гарантирует коммерческих прав на контент."
      }, {
  ...
  "help": {
    ...
    "faqs": [{
        ...
        "a": "Авторские права на контент принадлежат генерирующим движкам. Проверяйте условия каждого движка для коммерческого использования; DawnVision предоставляет только инструменты редактирования и постобработки."
      }, {
